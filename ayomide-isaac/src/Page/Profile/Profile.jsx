...
import EmblaCarousel from "../../Container/carousel/EmblaCarousel";
          ...
          <div className=" top-container top-conainer2 flex items-center ">
            ...
            <div className="h-[70%]   about-two p-0 md:pl-16 lg:px-20">
              <p className="font-bold text-3xl">
                He's a multi-faceted Lagos-based developer
              </p>
              <p className="mt-10 text-sm lg:text-[15px]">
                —Ayomide Isaac is a skilled Front-End, Mobile-App and WordPress
                developer with a passion for building dynamic, user-friendly
                applications. With experience in front-end, mobile-App and
                WordPress web-development, he has a knack for turning complex
                ideas into seamless digital experiences. Ayomide's expertise
                spans modern JavaScript frameworks, responsive design, and
                efficient API integrations, allowing him to deliver robust and
                scalable solutions across various platforms.
              </p>
              <p className="mt-10 text-sm lg:text-[15px]">
                His work reflects a commitment to clean code, innovative
                problem-solving, and a constant drive for improvement, making
                him a valuable asset in any tech-driven project.
              </p>
            </div>
          </div>
        </div>
    ...
    },
    {
      content: (
        <div className=" w-full h-full  flex items-center justify-center">
          <motion.div className="top-container p-5 md:p-14 lg:p-28 w-full">
            <div className="w-full md:w-3/4  h-full  text-left font-bold text-2xl lg:text-3xl">
              ...
              <div className="">
                "His journey as a Front-End. Mobile-App and WordPress
                web-developer is filled with challenges that inspire growth.
                Each setback is a lesson, fueling his passion for
                problem-solving and the endless possibilities in technology."
              </div>
            </div>
            ...
            <div className="lg:w-1/2 w-full  md:w-[30%] text-[16px] h-full flex items-center text-left pl-0 mt-5 md:mt-0 md:pl-10 lg:pl-20 md:text-[20px] leading-6 ">
              "Ayomide Isaac graduated with a B.Tech in Physics
              Telecommunications from the Federal University of Technology,
              Minna, and have been passionate about software development for
              over 4 years."
            </div>
          </motion.div>
        </div>
        ...
        <div className="flex bg-stone-900 text-white h-full items-center justify-center w-full ">
          <div className="top-container">
            ...
            <div className=" about-two p-0 md:pl-16 lg:px-20 flex flex-col justify-center items-center ">
              <div className="font-light w-full h-36 md:text-[200px] text-[100px] flex justify-center items-center work-p ">
                Work
              </div>
              <div className="hhh text-[17px] md:text-lg my-3 md:my-10 px-5 md:p-0">
                Ayomide Isaac as worked across different tech
                companies,realEstate companies, finTech companies,
                digitalmarketing companies and so on.
              </div>
              <div className="flex w-full md:mt-0 mt-3 md:p-0 px-5 items-center">
                <div className="work-direction">
                  <FontAwesomeIcon icon={faArrowDown} />
                </div>{" "}
                <div className="ml-5 w-60  text-[14px] md:text-[18px] leading-5">
        ...
        <div className="w-full h-full flex items-center justify-center ">
          <div className="flex md:flex-col flex-col-reverse w-[93%] md:w[90%]   ">
            <div className="w-full ">
              ...
              <a className="text-lg" href="https://gloo.com">
                www.gloo.com
              </a>
              <p className="md:text-[18px] text-[13px] my-1 ">
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Nesciunt hic, dolor ab at nostrum vel!
              </p>
              ...
              <div className="flex w-full justify-between mt-5 mobile">
                <div className="md:w-[75%] w-full md:h-[20vh] h-auto pb-5 md:pb-0  ">
                  <div className=" w-full">
                    ...
                    <span className="md:text-[14px] text-[14px]  leading-5 font-[400] ">
                      Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                      Qui quidem animi pariatur sint assumenda eligendi, ab,
                      similique, perspiciatis aliquam eius beatae! Cum inventore
                      magnam a amet molestias sit ratione sed neque, praesentium
                      quod eos quasi dolorem vel sequi dolorum eligendi labore
                      expedita accusantium vero ipsam facere autem quibusdam
                      perspiciatis blanditiis.
                    </span>
                  </div>
                </div>
                <div className="md:w-[30%] w-full flex justify-center h-full">
                  <button className="py-3 md:px-10 px-20 text-[15px] bg-black text-white rounded-[50px] ">
                    <a href="https://gloo.com">Visit</a>
                  </button>
                </div>
              </div>
            </div>
            ...
            <div className="md:mt-10 mt-2 mb-4 md:mb-0">
              <EmblaCarousel
                options={OPTIONS}
                slides={[gloo1, gloo2, gloo3, gloo4, gloo5, gloo6]}
              />
            </div>
          </div>
        </div>
          ...
          <div className="flex md:flex-col flex-col-reverse w-[93%] md:w[90%] ">
            <div className="w-full ">
              <h2 className="md:text-4xl text-3xl">
                DE-HELPMATE GLOBAL CONCEPT
              </h2>
              <a className="text-lg" href="https://dehelpmate.com.ng/">
                www.dehelpmate.com.ng
              </a>
              <p className="md:text-[18px] text-[13px] my-1">
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Nesciunt hic, dolor ab at nostrum vel!
              ...
              <div className="flex w-full justify-between mt-5 mobile">
                <div className="md:w-[75%] w-full md:h-[20vh] h-auto pb-5 md:pb-0  ">
                  <div className=" w-full">
                    <p className="mt-0 text-[20px] font-bold">Description:</p>
                    <span className="md:text-[14px] text-[14px]  leading-5 font-[400] ">
                      Collaborated with a team of frontend and backend
                      developers to design and develop a responsive and
                      feature-rich fintech website. Developed a WebView-based
                      mobile application that extended the functionality of the
                      fintech website to mobile users. Customized website
                      features for WebView, ensuring smooth navigation,
                      consistent design, and responsive layouts across devices.
                    </span>
                  </div>
                </div>
                <div className="md:w-[30%] w-full flex justify-center h-full">
                  <button className="py-3 md:px-10 px-20 text-[15px] bg-blue-600 text-white rounded-[50px] ">
                    <a href="https://gloo.com">Visit</a>
                  </button>
                </div>
              </div>
        ...
        <div className="w-full h-full flex items-center justify-center ">
          <div className="flex md:flex-col flex-col-reverse w-[93%] md:w[90%] ">
            <div className="w-full ">
              ...
              <a className="text-lg" href="https://nestebook.com/">
                www.nestebook.com
              </a>
              <p className="md:text-[18px] text-[13px] my-1">
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
              ...
              <div className="flex w-full justify-between mt-5 mobile">
                <div className="md:w-[75%] w-full md:h-[20vh] h-auto pb-5 md:pb-0  ">
                  <div className=" w-full">
                    <p className="mt-0 text-[20px] font-bold">Description:</p>
                    <span className="md:text-[14px] text-[14px]  leading-5 font-[400] ">
                      Designed and developed two fully functional WordPress
                      websites for the company, tailored to meet specific
                      business requirements and branding guidelines. Customized
                      WordPress themes and plugins to enhance website
                      functionality, ensuring a unique and user-friendly
                      experience Integrated third-party tools and APIs to
                      enhance website capabilities, including payment gateways,
                      email marketing platforms, and analytics tools
                    </span>
                  </div>
                </div>
                <div className="md:w-[30%] w-full flex justify-center h-full">
                  <button className="py-3 md:px-10 px-20 text-[15px] bg-orange-600 text-white rounded-[50px] ">
                    <a href="https://gloo.com">Visit</a>
                  </button>
                </div>
              </div>
      ...
      content: (
        <div className="w-full h-full flex items-center justify-center ">
          <div className="flex md:flex-col flex-col-reverse w-[93%] md:w[90%] ">
            <div className="w-full ">
              <h2 className="md:text-4xl text-3xl">
                NestGeeks Realty and Investment LTD
              </h2>
              <a className="text-lg" href="https://nestgeeks.org">
                www.nestgeeks.org
              </a>
              <p className="md:text-[18px] text-[13px] my-1 ">
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
              ...
              <div className="flex w-full justify-between mt-5 mobile">
                ...
                <div className="md:w-[30%] w-full flex justify-center h-full">
                  <button className="py-3 md:px-10 px-20 text-[15px] bg-lime-700 text-white rounded-[50px] ">
                    <a href="https://gloo.com">Visit</a>
                  </button>
                </div>
              </div>
        ...
        <div className="w-full h-full flex justify-center items-end md:items-center">
          <div className=" w-full h-[90%] md:h-[70%] thank">
            ...
            <div className="w-[95%] h-[50%] md:h-full flex  flex-col items-center">
              <h6 className="text-[80px] md:text-[200px] sm:text-[100px] ">
                Thank you!
              </h6>
              <div className="flex flex-wrap justify-center gap-2 p-4">
                ...
                <a
                  href="/AyomideIsaacResume (1).pdf"
                  download="AyomideIsaacResume CV.pdf">
    ...
    <div className="profile relative h-[100vh] w-full overflow-hidden">
      ...
      <motion.div
        ...
        <div className="w-full flex justify-between h-20  px-5 md:px-14 items-center">
          <a href="/home" className="text-sm sm:text-1xl uppercase">
            HOME
          </a>
          <a href="/Achieve" className=" text-sm sm:text-1xl uppercase">
            Achieve
          </a>
        </div>
